...
geometry_msgs::msg::Pose convertAndPrintGraspDataToBaseLink(const std::string& file_path, const tf2_ros::Buffer& tf_buffer, int line_number) {
...
int main(int argc, char** argv)
{
  ...
  // Create a publisher for the custom_gripper topic
  ...
  while (attempts <= 5) {
      ...
      double distance1 = 0.254;//Adjusting gripper length (other 0.170, with fruit 178) for rg2 baseline gripper, for fin-ray 0.250 (0.255 initial))
