...
class OnRobotGripperRG2Script(URScript):
    ...
    def _rg2_command(self, target_width=100, target_force=40, payload=0.5, set_payload=False, depth_compensation=False, slave=False):
...
class OnRobotGripperRG2(object):
    ...
    def close_gripper(self, target_width=17, target_force=40, payload=0.5, set_payload=False, depth_compensation=False, slave=False, wait=2):
        urscript = OnRobotGripperRG2Script()
        urscript._rg2_command(target_width, target_force, payload, set_payload, depth_compensation, slave)
        self.robot.send_program(urscript())
        time.sleep(3)
...
class GripperNode (Node):
    ...
    def listener_callback(self, msg):
        ...
        if msg.data == "open":
            ...
            self.gripper.close_gripper(5) # 1 for rg2 baseline, 17 for fin-ray gripper 23 for try 2
